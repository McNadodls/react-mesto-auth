...
function App() {
  ...
  const [stateInfoTooltip, swapStateInfoTooltip] = useState({
    open: false,
    status: false,
  });
  ...
  return (
    <CurrentUserContext.Provider value={currentUser}>
      ...
      <EditCardPopup
        ...
        textSubmit={"Создать"}
        isOpen={stateEditCard}
        onClose={closeAllPopups}
      ></EditCardPopup>
      <EditAvatarPopup
        handleInputValues={handleChange}
        onSubmit={handleAvatarInfo}
        namePopup={"avatar"}
        titlePopup={"Обновить аватар"}
        textSubmit={"Сохранить"}
        isOpen={stateEditAvatar}
        onClose={closeAllPopups}
      ></EditAvatarPopup>
      <InfoTooltip
        status={stateInfoTooltip.status}
        isOpen={stateInfoTooltip.open}
        onClose={closeAllPopups}
      ></InfoTooltip>
